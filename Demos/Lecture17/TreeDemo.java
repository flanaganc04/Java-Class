...
public class TreeDemo
{
    ...
    public static final int TREE_TOP_WIDTH = 121;// must be odd
    public static final int TREE_BOTTOM_WIDTH = 40;
    public static final int TREE_BOTTOM_HEIGHT = 1000000000;
	...
	public static void drawTree(int topWidth, int bottomWidth, int bottomHeight)
	{
        ...
        RectangleInterface treeTrunk = new Rectangle2(INDENT + (topWidth / 2) - (bottomWidth / 2),
